...
class Tracker4(hass.Hass):
  ...
  def initialize(self):
    ...
    self.log("##############################################################################################")
    self.listen_state(self.left_home,    self.tracker, old="home",         new="not_home",     duration=120)
    self.listen_state(self.reached_home, self.tracker, old="not_home",     new="home",         duration=120)
